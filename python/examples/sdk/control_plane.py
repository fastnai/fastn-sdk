...
Demonstrates the admin API for introspecting the tool registry without
...
def main() -> None:
    ...
    print(f"\n=== Connector: {CONNECTOR} ===")
    connector = fastn.admin.connectors.get(CONNECTOR)
